 ...
 */
package com.umg.jpa.controller;

import com.umg.jpa.controller.exceptions.NonexistentEntityException;
...
public class EmpleadosJpaController implements Serializable {
    ...
    public EmpleadosJpaController() {
        emf = Persistence.createEntityManagerFactory("com.umg_JPA_EJEMPLO_jar_1.0-SNAPSHOTPU");
